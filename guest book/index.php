...
<body>
	...
	<form method="post" action="confirm.php">
		<table>
			<tr>
				<th>名前</th>
				<td><input type="text" name="m_name" size="30" required></td>
			</tr>
			<tr>
				<th>メールアドレス</th>
				<td><input type="email" name="m_mail" size="30" required></td>
			</tr>
			<tr>
				<th>メッセージ</th>
				<td><textarea rows="5" cols="30" name="m_message" required></textarea></td>
			</tr>
			<tr>
